...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { date: @map.date, description: @map.description, latitude: @map.latitude, longitude: @map.longitude }
    end
  ...
  test "should update map" do
    put :update, id: @map, map: { date: @map.date, description: @map.description, latitude: @map.latitude, longitude: @map.longitude }
    assert_redirected_to map_path(assigns(:map))
  end
